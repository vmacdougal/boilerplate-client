        ...
        <div className='row'>
          <div className='col-lg-12'>
            ...
            <Panel>
              ...
              <p>Dont want your columns to simply stack in smaller devices?
        ...
        <div className='row'>
          <div className='col-lg-12'>
            ...
            <Panel>
              ...
              <p>Build on the previous example by creating even more dynamic
          ...
          <div className='col-lg-12'>
            ...
            <Panel>
              ...
              <p>
                ...
                combination of a
                <code>.clearfix</code> and our <a href='#'>responsive utility
                classes</a>.
              </p>
              <div className='row show-grid'>
