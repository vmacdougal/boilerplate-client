        ...
        <div className='row'>
          <div className='col-lg-6'>
            ...
            <Panel header={<span>Circle Icon Buttons with Font Awesome Icons</span>} >
              ...
              <Button bsStyle='primary' className='btn-circle'>
              ...
              <Button bsStyle='danger' className='btn-circle'>
                <i className='fa fa-heart' />
              </Button>
              <br />
              <br />
              <h4>Large Circle Buttons</h4>
              <Button bsSize='large' className='btn-circle'>
                <i className='fa fa-check' />
              </Button>
            ...
            <Panel header={<span>Outline Buttons with Smooth Transition</span>} >
              ...
              <p>
                <Button bsStyle='primary'
                  ...
                  bsSize='large'>Large button</Button>
                <Button bsStyle='primary'
                  className='btn-outline'>Default button</Button>
                <Button bsStyle='primary'
                  className='btn-outline'
                  bsSize='small'>Small button</Button>
                <Button bsStyle='primary'
                  className='btn-outline'
                  bsSize='xsmall'>Mini button</Button>
                <br />
                <br />
                <Button bsStyle='primary'
                  className='btn-outline'
                  bsSize='large' block>Block level button</Button>
              </p>
            </Panel>
