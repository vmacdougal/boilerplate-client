              ...
              <div className='row'>
                <div className='col-lg-6'>
                  <form>
                    ...
                    {
                    /*
                      app/src/components/pages/dashboard/Forms.jsx:
                      ...
                      <FormControls.Static label='Static Control'>
                        email@example.com
                      </FormControls.Static>
                    */
                    }
                    ...
                    <Input type='radio' name='radioX' label='Radio 1' />
                    <Input type='radio' name='radioX' label='Radio 2' />
                    <Input type='radio' name='radioX' label='Radio 3' />
                    ...
                    <Row>
                      ...
                      <Col xs={1}>
                        <Input type='radio' name='radioY' label='1' />
                      </Col>
                      <Col xs={1}>
                        <Input type='radio' name='radioY' label='2' />
                      </Col>
                      <Col xs={1}>
                        <Input type='radio' name='radioY' label='3' />
                      </Col>
                    </Row>
                ...
                <div className='col-lg-6'>
                  ...
                  <form>
                    ...
                    <Input type='select'
                      label='Disabled select menu' disabled>
                      <option>Disabled select</option>
                    </Input>
                    <Input type='checkbox'
                      label='Disabled Checkbox' disabled />
                    <Button bsStyle='primary'
                      type='submit' disabled>Disabled Button</Button>
                  </form>
                  ...
                  <form>
                    ...
                    <Input type='text'
                      addonBefore=<i className='fa fa-eur' />
                      placeholder='Font Awesome Icon' />
                    <Input type='text' addonBefore='$' addonAfter='.00' />
                    <Input type='text'
                      buttonAfter=<Button><i className='fa fa-search' /></Button> />
                  </form>
                </div>
              </div>
            </Panel>
