...
```
{
  ...
  "rules": {
    ...
    ////////// Stylistic Issues //////////
    "indent": [2, 2],
    "brace-style": [2, "stroustrup", { "allowSingleLine": false }], // enforce one true brace style (off by default)
    ...
    "keyword-spacing": [2, {"before": true, "after": true, "overrides": {}}], // require spaces before and or after keywords
    ...
    "generator-star-spacing": [2, {"before": true, "after": false}], // enforce the position of the * in generator functions (off by default)


    ////////// Legacy //////////

    "max-depth": [1, 3],  // specify the maximum depth that blocks can be nested (off by default)
    # "max-len": [1, 80],   // specify the maximum length of a line in your program (off by default)
